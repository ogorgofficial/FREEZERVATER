...
# Required channels to join (USE ID OR USERNAME WITHOUT @)
REQUIRED_CHANNELS = [
    {"link": "https://t.me/GODFATHERCHECKER", "username": "GODFATHERCHECKER"},
    {"link": "https://t.me/+z2YaHNRE8u5hZjFl", "username": "z2YaHNRE8u5hZjFl"}
]
...
def check_user_channels(user_id):
    """
    Check if user has joined all required channels - FIXED VERSION
    """
    try:
